...
public struct Transcript: Sendable, Equatable, Codable {
    ...
    public enum Segment: Sendable, Identifiable, Equatable, Codable {
        ...
        /// A segment containing tool calls.
        case toolCalls(ToolCallsSegment)
    ...
    /// A segment containing tool calls.
    ///
    /// Use this type to represent tool calls that appear as part of a model response.
    /// This allows tracking tool calls within response segments rather than only as
    /// separate transcript entries.
    public struct ToolCallsSegment: Sendable, Identifiable, Equatable, Codable {
        /// The stable identity of the entity associated with this instance.
        public var id: String

        /// The tool calls contained in this segment.
        public var calls: [ToolCall]

        /// Creates a tool calls segment.
        ///
        /// - Parameters:
        ///   - id: A unique identifier for this segment. Defaults to a generated UUID.
        ...
        /// Creates a tool calls segment from a sequence of tool calls.
        ///
        /// - Parameters:
        ///   - id: A unique identifier for this segment. Defaults to a generated UUID.
        ///   - calls: A sequence of tool calls.
        public init<S>(id: String = UUID().uuidString, calls: S) where S: Sequence, S.Element == ToolCall {
            self.id = id
...
extension Transcript.ToolCallsSegment: CustomStringConvertible {
    public var description: String {
        "ToolCallsSegment(\(calls.count) calls)"
    }
}
